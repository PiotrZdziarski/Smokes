...
@section('content')
  <div style="width: 100%; min-height: 60px; font-size: 22px; padding-top: 11px;padding-right: 5%;text-align: center;padding-left: 5%;background-color: #333333; margin-top: 38px; margin-bottom: 35px;">
...
<div class="container">
  <div class="row justify-content-left" style="">
    <div media="(min-device-width: 640px)" style="width:25%; margin-left: 60%;height: 150px; position: absolute; margin-top: 80px;">
      <div style="border: 1px solid #333333; background-color: #111111; border-radius: 4px;padding: 15px; width: 100%; margin-left: 10%;">
        <a href="https://www.facebook.com/profile.php?id=100007072909482">
          <img src="{{Asset('storage/images/facebook.png')}}" style="width: 40%;height: 130px; margin-left: 1%;">
        </a>
        <a href="https://plus.google.com/u/0/114869168099549108892">
        ...
        <div class="col-md-8" style="margin-bottom: 50px;">
          ...
          @if(isset($users))
            ...
            @endforeach
          @endif
<div style="width: 100%; text-align:center; margin-bottom: -10px;"><span style="font-size: 26px; color: #d5c000;">Category: {{$searchedcategory}}</span></div>
        </div>
        ...
        <div class="col-md-8" style="">
          <div class="row justify-content-center" style="">
            <div class="card" style="border:0; width: 100%; margin-bottom: 50px;">
                <div class="card-header" style="background-color: black; color:white; padding-left: 4%;">{{$meme->author}}</div>

                <div class="card-body" id="{{$meme->id}}" style="background-color: #222222; color: #cccccc; @if(!isset(Auth::user()->name)) padding-bottom: 26px;@endif @if(isset(Auth::user()->name)) padding-bottom: 15px;@endif padding-left: 2%; padding-right: 2%; padding-top: 15px;">
                    ...
                    @if(isset(Auth::user()->name) && $meme->id != session('status'))
                      <form method="post" action="{{Route('sites.likingcategory')}}">
                        <input name="_token" value="{{csrf_token()}}" type="hidden">
                        <input type="hidden" value="{{$meme->likes}}" name="likes">
                        <input type="hidden" value="{{$meme->id}}" name="likeid">
                        <input type="hidden" value="{{$searchedcategory}}" name="category">
                      ...
                      <form method="post" action="{{Route('sites.dislikingcategory')}}">
                        <input name="_token" value="{{csrf_token()}}" type="hidden">
